            ...
            <div class="max-w-10xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-20"
                    ...
                    <div class="grid grid-cols-6 md:grid-cols-1 gap-6 lg:gap-1 place-items-center" style="width: 600px;">
                        ...
                        <div v-if="$page.props.auth.user" class="grid grid-cols-6 md:grid-cols-1 gap-6 lg:gap-1 place-items-center" style="width: 600px;">
                            <Link
                                v-if="$page.props.auth.user && userHasPermissions($page.props.auth.user.permissions, RBAC.Admin)"
                                :href="route('reading')"
                            ...
                            <Link
                                v-if="userHasPermissions($page.props.auth.user.permissions, RBAC.Admin)"
                                :href="route('words')"
                                class="scale-75 mt-5 h-16 p-6 text-2xl font-semibold justify-center border-sol w-3/6 bg-gray-300 from-gray-700/50 via-transparent rounded-lg shadow-2xl flex motion-safe:hover:scale-[1.01]">
                            <div>
                                Visi žodžiai
                            ...
                            <div v-if="$page.props.auth.user.permissions > 1"
